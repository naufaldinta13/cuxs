...
func TestEchoRoutes(t *testing.T) {
	e := New()
	routes := []echo.Route{
		{Method: echo.GET, Path: "/users/:user/events", Name: ""},
		{Method: echo.GET, Path: "/users/:user/events/public", Name: ""},
		{Method: echo.POST, Path: "/repos/:owner/:repo/git/refs", Name: ""},
		{Method: echo.POST, Path: "/repos/:owner/:repo/git/tags", Name: ""},
		{Method: echo.PUT, Path: "/repos/:owner/:repo/git/tags", Name: ""},
	}
